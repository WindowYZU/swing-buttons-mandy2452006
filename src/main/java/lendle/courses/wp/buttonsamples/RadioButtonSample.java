...
public class RadioButtonSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JToggleButton toggleButton=new JToggleButton("button1");
        frame.add(radio1);
        frame.add(radio2);
        frame.add(checkbox);
        ...
        ActionListener listener=new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null,"radio1="+radio1.isSelected()+" ,radio2="+radio2.isSelected()+" ,check1="+checkbox.isSelected()+" ,button1="+toggleButton.isSelected());
            }
        };
